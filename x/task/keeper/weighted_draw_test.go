...
func TestWeightedDrawIsIndependentOfInputOrder(t *testing.T) {
	...
	candidates := []types.TaskCandidateFactState{
		{Slot: 9, SlotVersion: 1, OperatorAddress: "trueopen1c5l3xut9207qyhajegcep54t0k50n4zh5l43sr", CandidateWeight: 1},
		{Slot: 2, SlotVersion: 1, OperatorAddress: "trueopen1dyyce5xm8rdlgghm3v2f8asnl8g3xtl4a2ks5q", CandidateWeight: 3},
	}
