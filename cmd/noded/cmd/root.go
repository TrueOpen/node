...
func NewRootCmd() *cobra.Command {
	...
	if err := replaceQueryCommands(rootCmd, autoCliOpts); err != nil {
		panic(err)
	}
...
func ProvideClientContext(
	...
	app.RegisterEthereumAccountEncoding(legacyAmino, interfaceRegistry)
	clientCtx := client.Context{}.
		WithCodec(appCodec).
		...
		WithPreprocessTxHook(canonicalizeDirectTxSignatures) // env variable prefix
